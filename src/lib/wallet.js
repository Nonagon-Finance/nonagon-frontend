...
let _provider = new ethers.providers.JsonRpcProvider('https://ancient-bitter-knowledge.optimism.quiknode.pro/f1011779dc872773e3081c32c5975361491d748f/');
			...
			try {
				await wallet.request({
					...
					params: [{
						chainId: '10',
						chainName: 'Optimism',
						rpcUrls: [CHAINDATA[10]['rpc']],
						nativeCurrency: {
							name: 'ETH',
							symbol: 'ETH',
							decimals: 18
						},
						blockExplorerUrls: [CHAINDATA[10]['explorer']]
					}],
				});
			} catch (addError) {
				// handle "add" error
