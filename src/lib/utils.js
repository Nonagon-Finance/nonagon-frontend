...
export function setTitle(product, price) {
	if (get(currentPage) == 'trade') {
		document.title = `${product} ${price} | ONA`;
	}
}
...
export function formatCurrency(_currencyLabel) {
	...
	if (_currencyLabel.toLowerCase() == 'solana') return 'SOLANA';
	if (_currencyLabel.toLowerCase() == 'ltc') return 'LITECOIN';
	if (_currencyLabel.toLowerCase() == 'link') return 'LINK';
	if (_currencyLabel.toLowerCase() == 'doge') return 'DOGE';
	if (_currencyLabel.toLowerCase() == 'ada') return 'ADA';
	if (_currencyLabel.toLowerCase() == 'algo') return 'ALGO';
	if (_currencyLabel.toLowerCase() == 'xlm') return 'XLM';
	if (_currencyLabel.toLowerCase() == 'atom') return 'ATOM';
	if (_currencyLabel.toLowerCase() == 'dot') return 'DOT';
	if (_currencyLabel.toLowerCase() == 'icp') return 'ICP';
	if (_currencyLabel.toLowerCase() == 'bch') return 'BCH';
	if (_currencyLabel.toLowerCase() == 'crv') return 'CRV';
	if (_currencyLabel.toLowerCase() == 'aave') return 'AAVE';
	if (_currencyLabel.toLowerCase() == 'xtz') return 'XTZ';
	if (_currencyLabel.toLowerCase() == 'yfi') return 'YFI';
	if (_currencyLabel.toLowerCase() == 'celo') return 'CELO';
	if (_currencyLabel.toLowerCase() == 'eos') return 'EOS';
	if (_currencyLabel.toLowerCase() == 'sushi') return 'SUSHI';
...
export function loadRoute(path, isInitial) {
	if (!path || path == '/' || path.includes('/home')) {
		...
		document.title = `Free Decentralized Perpetual Exchange | ONA`;
	} else if (path.includes('/trade')) {
		component.set(Trade);
		currentPage.set('trade');
		document.title = `Trade | ONA`;
	} else if (path.includes('/pool')) {
		component.set(Pool);
		currentPage.set('pool');
		document.title = `Pool | ONA`;
	} else if (path.includes('/buy')) {
		component.set(Buy);
		currentPage.set('buy');
		document.title = `Buy ONA | ONA`;
	}
	hydrateData();
}
